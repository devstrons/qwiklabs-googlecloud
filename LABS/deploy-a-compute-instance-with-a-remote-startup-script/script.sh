...
# Task 4: Connect to the server ip-address using HTTP and get a non-error responseV
- Compute Engine > VM Instances > example-instance > Edit > Check "Allow HTTP traffic" > Save
- VPC Network > Firewall > Delete "allow-http"
